...
export const stream417: StreamEntry[] = [
  ...
  },
  {
    ...
    trace: {
      ...
      evidence: [
        { kind: 'document', label: 'Passport (Aisha)', source: 'd1' },
        { kind: 'document', label: 'Payslip (Aisha)', source: 'd2' },
        { kind: 'document', label: 'P60 (Aisha)', source: 'd3' },
        { kind: 'document', label: 'Payslip (Daniel · first)', source: 'd7' },
      ],
      confidence: 0.93,
    },
    schemaVersion: CRM_SCHEMA_VERSION,
