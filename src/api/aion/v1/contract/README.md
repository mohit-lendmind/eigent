...
- Last synced from: aion-v1 commit `c840bdd` on main, together with
  `test/fixtures/aion/eigent/v1/`. The spec files themselves last changed in
  PR #157 (`skills: readable usage counters`); PR #158 only added a fixture.
